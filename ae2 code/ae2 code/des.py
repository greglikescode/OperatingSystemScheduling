...
class SchedulerDES(object):
    ...
    def __init__(self, *, num_processes, arrivals_per_time_unit, avg_cpu_burst_time, context_switch_time=0.0,
        ...
        - quantum: max amountc of time for which to execute the selected process (defaults to math.inf, i.e., batch mode)
        """
    ...
    def run(self, seed=None):
        ...
        while self.events_queue:
            ...
            #TEMP
            print("RUNNING THIS: ",process_to_run.process_id)
    ...
    def scheduler_func(self, cur_event):
        #EDIT
        #Call the scheduler_func() dependant on the scheduler used
